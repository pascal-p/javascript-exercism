...
describe('Matching Brackets', () => {
  ...
  test('no brackets at all', () => {
    expect(isPaired('sdfhgkasdhfkashkd, 9sjdh, kahsdk9shdkajhd')).toEqual(true);
  });

  test('some well formed brackets', () => {
    expect(isPaired('[(sdfhgkasdhfkashkd (9sjdh) kahsdk9shdkajhd)][{{}}]asasas')).toEqual(true);
  });

  test('some non well formed brackets', () => {
    expect(isPaired('[(sdfhgkasdhfkashkd (9sjdh) kahsdk9shdkajhd)]{{}]asasas')).toEqual(false);
  });
