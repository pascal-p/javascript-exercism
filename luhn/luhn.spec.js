...
describe('Luhn', () => {
  ...
  test('single zero with space is invalid /1', () => {
    expect(valid(' 0')).toEqual(false);
  });

  test('single zero with space is invalid /2', () => {
    expect(valid('0 ')).toEqual(false);
  });

  test('single zero with spaces is invalid /3', () => {
    expect(valid('\t\t0 ')).toEqual(false);
  });
  ...
  test('valid Canadian SIN', () => {
    ...
    expect(valid('234 567 891 234')).toEqual(true); // made-up
  });
  ...
  test('valid (pseudo) credit cards', () => {
    expect(valid('4539 3195 0343 6467')).toEqual(true);

    // w/o spaces
    expect(valid('4539319503436467')).toEqual(true);

    expect(valid('8273 1232 7352 0869')).toEqual(true);
  });
