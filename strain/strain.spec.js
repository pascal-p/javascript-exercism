...
describe('strain', () => {
  ...
  // Addition
  test('keeps evertyhing', () => {
    const words = 'apple zebra banana zombies cherimoya zelot'.split(' ');
    const result = keep(words, () => true);
    expect(result).toEqual('apple zebra banana zombies cherimoya zelot'.split(' '));
  });
  ...
  // Addition
  test('discards nothing', () => {
    const result = discard([1, 2, 3, 4, 5], () => false);
